...
→ **[INDEX.md](INDEX.md)** — Master navigation for the entire knowledge base
...
├── PROJECT_CONTEXT.md      ← Repository purpose and governance
...
│
├── # Business Units
├── recycling/              # Processing ops, commodity markets, compliance
├── energy/                 # Asset portfolio, trading, regulatory, pipeline
├── esg/                    # Environmental, Social, Governance — targets & reporting
│
├── # Corporate Functions
├── company/                # Mission, org structure, culture, onboarding
├── strategy/               # OKRs, competitive intelligence, annual planning
